...
M.window = {
  n = {
    ["<C-h>"] = { "<cmd>TmuxNavigateLeft<cr>" , "Window Move left" },
    ["<C-k>"] = { "<cmd>TmuxNavigateUp<cr>", "Window Move Up" },
    ["<C-j>"] = { "<cmd>TmuxNavigateDown<cr>" , "Window Move Down" },
    ["<C-l>"] = { "<cmd>TmuxNavigateRight<cr>", "Window Move Right" },
    ["<c-\\>"] = { "<cmd>TmuxNavigatePrevious<cr>", "Window Move Prev"},
